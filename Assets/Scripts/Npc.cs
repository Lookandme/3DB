...
public class NPC : MonoBehaviour, IDamagable
{
    ...
    void AttackingUpdate()
    {
        if (playerDistance > attackDistance || !IsPlayerInFieldOfView())
        {
            ...
            {
                agent.SetDestination(CharcterManager.Instance.Player.transform.position);
            }
            else
            {
    ...
    {
        return Vector3.Angle(transform.position - CharcterManager.Instance.Player.transform.position, transform.position + targetPos);
    }
